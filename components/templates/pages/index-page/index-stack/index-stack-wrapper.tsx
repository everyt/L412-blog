import 'Styles/templates/pages/index-page/index-stack/index-stack-wrapper.scss';
...
export default function StackWrapper({ icon, color = 'black', fontSize, style, children }: StackProps) {
